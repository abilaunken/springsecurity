...
public class UserDetailsImpl implements UserDetails {
    ...
    public String getPassword() {
        return user.getPassword();// Retorna a credencial do usuário que criamos anteriormente
    }

    @Override
    public String getUsername() {
        return user.getEmail(); // Retorna o nome de usuário do usuário que criamos anteriormente
    }
